...
#+BEGIN_SRC clojure :tangle babel/src-cljx/thi/ng/geom/polygon.cljx
  ...
  (extrude-shell
   [{points :points :as this}
    {:keys [depth offset inset top? bottom? wall]
     :or {wall 1.0 depth 1.0 inset 0.0 top? true bottom? true}}]
   (let [points (if (neg? (g/area this)) (reverse points) points)
         ...
         outsides (mapcat (fn [[a1 b1] [a2 b2]] [[a1 b1 a2] [b1 b2 a2]])
                          (d/successive-nth 2 (conj points3 (points3 0)))
                          (d/successive-nth 2 (conj tpoints3 (tpoints3 0))))
         insides (mapcat (fn [[a1 b1] [a2 b2]] [[a1 a2 b1] [b1 a2 b2]])
                         (d/successive-nth 2 (conj ipoints3 (ipoints3 0)))
                         (d/successive-nth 2 (conj itpoints3 (itpoints3 0))))]
     (mesh/into-mesh
      (mesh/mesh3) nil
      (concat
       (if bottom?
         ...
         (mapcat (fn [[a1 b1] [a2 b2]] [[a1 a2 b1] [b1 a2 b2]])
                 (d/successive-nth 2 (conj points3 (points3 0)))
                 (d/successive-nth 2 (conj ipoints3 (ipoints3 0)))))
       outsides
       insides
