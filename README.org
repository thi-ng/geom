...
- [[./examples/gl/jogl.org][OpenGL demos]]
- [[./examples/gl/webgl.org][WebGL demos]] (source + links to live versions)
- [[./examples/svg/demos.org][SVG examples]]
- [[./examples/viz/demos.org][Visualization examples]]
- [[./examples/types/ptf.org][PTF mesh examples]]
...
Growing list of [[http://workshop.thi.ng/][thi.ng workshop]] repositories (These workshops are running
on a monthly basis & internationally):
...
#+NAME: dep-color
#+BEGIN_SRC clojure
[thi.ng/color "1.2.0-SNAPSHOT"]
#+END_SRC

**** [[https://github.com/thi-ng/dstruct][thi.ng/dstruct]]
#+NAME: dep-dstruct
#+BEGIN_SRC clojure
[thi.ng/dstruct "0.2.0-SNAPSHOT"]
#+END_SRC
