...
Clojure, the following additional native dependencies must be added to
your project (for each platform you intend to use):
...
| =thi.ng.geom.webgl.buffers=      | =thi.ng.geom.gl.buffers=         |
| =thi.ng.geom.webgl.core=         | =thi.ng.geom.gl.core=            |
| =thi.ng.geom.webgl.shaders=      | =thi.ng.geom.gl.shaders=         |
|----------------------------------+----------------------------------|
|                                  | =thi.ng.geom.attribs=            |
...
#+NAME: dep-tarrays
#+BEGIN_SRC clojure
[thi.ng/typedarrays "0.1.6-SNAPSHOT"]
#+END_SRC
