...
[[http://media.thi.ng/geom/svg/suzanne-phong.svg]]
...
#+BEGIN_SRC clojure :tangle ../babel/examples/svgdemo02.clj :mkdirp yes :padline no
  (ns svgdemo02
    (:require
     ...
     [thi.ng.geom.svg.shader :as shader]
...
| [[http://media.thi.ng/geom/svg/rings-diffuse.svg]] | [[http://media.thi.ng/geom/svg/rings-lambert.svg]] | [[http://media.thi.ng/geom/svg/rings-phong.svg]] |
...
[[http://media.thi.ng/geom/svg/spiral.svg]]
...
#+BEGIN_SRC clojure :tangle ../babel/examples/svgdemo04.clj :mkdirp yes :padline no
  ...
  (->> (svg/svg
        ...
        (svg/defs
          (apply svg/radial-gradient-hsb "rainbow" rainbow-gradient))
        (svg/line-strip
...
[[http://media.thi.ng/geom/svg/instancing.svg]]
...
#+BEGIN_SRC clojure :tangle ../babel/examples/svgdemo05.clj :mkdirp yes :padline no
  ...
  (->> (svg/svg
        ...
        (svg/defs
          (apply svg/radial-gradient-hsb "rainbow-rad" rainbow-gradient)
          (apply svg/linear-gradient-hsb "rainbow-lin" rainbow-gradient)
          (svg/line-strip
...
[[http://media.thi.ng/geom/svg/decorators.svg]]
