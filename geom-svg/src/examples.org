...
| [[http://media.thi.ng/geom/svgdemo02-diffuse.svg]] | [[http://media.thi.ng/geom/svgdemo02-lambert.svg]] | [[http://media.thi.ng/geom/svgdemo02-phong.svg]]?1407779686873 |
...
#+BEGIN_SRC clojure :tangle ../babel/examples/svgdemo02.clj :mkdirp yes :padline no
  ...
  (def diffuse  (svg/normal-rgb (g/rotate-y (mat/matrix44) m/PI)))
