...
* Contents                                                         :toc_4_gh:
 - [[#namespace-thinggeomsvgshader][Namespace: thi.ng.geom.svg.shader]]
     - [[#protocols][Protocols]]
         - [[#pshader][PShader]]
     - [[#shaders][Shaders]]
     - [[#complete-namespace-definition][Complete namespace definition]]

* Namespace: thi.ng.geom.svg.shader
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/svg/shader.cljx :noweb yes :mkdirp yes :padline no
