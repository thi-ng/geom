...
face list generator, scale and optional subdivision scheme and returns
either a =BasicMesh= or =GMesh= instance.

#+BEGIN_SRC clojure 
  ;; import subdivsion ns
  (require '[thi.ng.geom.mesh.subdivision :as 

  ;; create icosahedron sphere (3x subdivided)
  (def sphere (polyhedron-mesh icosahedron sd/catmull-clark 1 3))
#+END_SRC
