...
#+BEGIN_SRC clojure :noweb-ref main
  (def box
    (-> ;;(r/rect 100)
     ...
     (g/as-polygon)
     (g/extrude-shell
      {:depth 100 :wall 25 :inset 10 :top? false :bottom? true :mesh (bm/basic-mesh)})
     (g/tessellate)))

  (def box (with-open [i (io/input-stream "/Users/toxi/work/clj/devart-template/project_code/dev/exhibit-mockup/canopy-flat-12.stl")] (mio/read-stl i)))
