...
| Line plot (cartesian)                       | Line plot (polar)                           |
...
| Area plot (cartesian)                             | Area plot (polar)                                 |
...
| Single value per domain position        | 3 interleaved values                               |
...
| 6 categories, 3 data sets                    | 6 categories, 3 data sets, min-max intervals      |
