...
growing) set of optimized vector, matrix & quaternion
...
on, incl. WebGL & SVG support via Clojurescript. Together with sister
...
*** Note for Github users                                          :noexport:
...
source files via the normal [[https://github.com/thi-ng/tree/master/][GH repo browser]].
