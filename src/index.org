...
*** [[file:../geom-svg/src/index.org][geom-svg]]

A module to help with building SVG based visualizations of geom
entities (incl. a customizable 3D mesh renderer). CLJS support for
this module is planned, but currently untested.
...
- [[http://dev.thi.ng/20140523/][WebGL demo]]
