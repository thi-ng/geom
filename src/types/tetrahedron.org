...
#+BEGIN_SRC clojure :noweb-ref impl
  ...
  (rotate-x
   [_ theta]
   (thi.ng.geom.types.Tetrahedron. (mapv #(g/rotate-x % theta) (get _ :points))))
  (rotate-y
   [_ theta]
   (thi.ng.geom.types.Tetrahedron. (mapv #(g/rotate-y % theta) (get _ :points))))
  (rotate-z
   [_ theta]
   (thi.ng.geom.types.Tetrahedron. (mapv #(g/rotate-z % theta) (get _ :points))))
  (rotate-around-axis
   [_ axis theta]
   (thi.ng.geom.types.Tetrahedron.
  ...
  (scale
   ([_ s]
      (thi.ng.geom.types.Tetrahedron. (mapv #(m/* % s) (get _ :points))))
   ([_ sx sy]
      (thi.ng.geom.types.Tetrahedron. (mapv #(m/* % sx sy) (get _ :points))))
   ([_ sx sy sz]
      (thi.ng.geom.types.Tetrahedron. (mapv #(m/* % sx sy sz) (get _ :points)))))
  (scale-size
   [_ s] (thi.ng.geom.types.Tetrahedron. (gu/scale-size s (get _ :points))))
  g/ITranslate
  (translate
   [_ t]
   (thi.ng.geom.types.Tetrahedron. (mapv #(m/+ % t) (get _ :points))))
  g/ITransform
  (transform
   [_ m]
   (thi.ng.geom.types.Tetrahedron. (mapv #(g/transform-vector m %) (get _ :points))))
#+END_SRC
**** IVolume
