...
#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/shaders.cljs :noweb yes :mkdirp yes :padline no
...
#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/shaders/basic.cljs :noweb yes :mkdirp yes :padline no
...
#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/shaders/lambert.cljs :noweb yes :mkdirp yes :padline no
...
#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/shaders/phong.cljs :noweb yes :mkdirp yes :padline no
...
#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/shaders/xray.cljs :noweb yes :mkdirp yes :padline no
...
#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/shaders/spotlight.cljs :noweb yes :mkdirp yes :padline no
...
#+BEGIN_SRC glsl :noweb-ref image-fs
  void main() {
    gl_FragColor = texture2D(tex, vUV) * tint;
  }
#+END_SRC

#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/shaders/image.cljs :noweb yes :mkdirp yes :padline no
  ...
  (defn make-shader-spec
    ...
    ([^WebGLRenderingContext gl opts]
     (let [r         (or (get opts :rect) (r/rect 1))
           ...
           verts     (ta/float32 8)]
       (streams/into-float-buffer [a b d c] verts 2 0)
