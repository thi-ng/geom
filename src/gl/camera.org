...
* Contents                                                         :toc_4_gh:
 - [[#thinggeomglcamera][thi.ng.geom.gl.camera]]
...
#+BEGIN_SRC clojure :noweb-ref cam
  ...
  (defn set-projection
    ...
    (let [cam (update-keys cam  [:fov :aspect :near :far] opts)]
      (assoc cam :proj (gl/perspective (get cam :fov) (get cam :aspect) (get cam :near) (get cam :far)))))
...
#+BEGIN_SRC clojure :tangle ../../babel/src/thi/ng/geom/gl/camera.cljs :noweb yes :mkdirp yes :padline no
