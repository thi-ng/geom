...
#+BEGIN_SRC clojure :noweb-ref ctors
  (defn indexed-mesh
    [] (thi.ng.geom.types.IndexedMesh. (idx/bidir-index) [] {}))
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref impl
  (defn- add-face*
    ...
    (let [[vindex vids] (idx/index-items (:vertices mesh) verts)
...
#+BEGIN_SRC clojure :noweb-ref impl
  ...
  (compute-face-normals
   ...
   (let [vertices (:vertices _)]
     (loop [fnorms (idx/bidir-index), faces' (transient []), faces (:faces _)]
       (if faces
         (let [^thi.ng.geom.meshface.IndexedMeshFace f (first faces)
               fverts     (idx/attrib-values vertices (.-vertices f))
               [fnorms n] (idx/index-item fnorms (gu/ortho-normal fverts))
