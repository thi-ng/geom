...
#+BEGIN_SRC clojure :noweb-ref impl
  g/PRotate
  (rotate
   [_ theta] (g/rotate-z (box/box (:p _) (:size _)) theta))
  
  g/PRotate3D
  (rotate-x
   [_ theta] (g/rotate-x (box/box (:p _) (:size _)) theta))
  (rotate-y
   [_ theta] (g/rotate-y (box/box (:p _) (:size _)) theta))
  (rotate-z
   [_ theta] (g/rotate-z (box/box (:p _) (:size _)) theta))
  (rotate-around-axis
   [_ axis theta] (g/rotate-around-axis (box/box (:p _) (:size _)) axis theta))
  ...
  g/PTransform
  (transform
   [_ m] (g/transform (box/box (:p _) (:size _)) m))
#+END_SRC
