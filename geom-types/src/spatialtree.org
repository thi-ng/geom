...
#+BEGIN_SRC clojure :noweb-ref impl
  ...
  #+clj (defmethod print-method MutableQuadtreeNode [^MutableQuadtreeNode o ^java.io.Writer w] (.write w (.toString o)))
  #+clj (defmethod print-method MutableOctreeNode [^MutableOctreeNode o ^java.io.Writer w] (.write w (.toString o)))
#+END_SRC
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/spatialtree.cljx :noweb yes :mkdirp yes :padline no
