...
*** PCenter                                                     :usetemplate:
#+BEGIN_SRC clojure :noweb-ref impl :noweb yes
  <<lob-geom-center(type="thi.ng.geom.types.Polygon2")>>
  (centroid
   [{points :points :as _}]
   (let [c (->> points
                (d/rotate-left 1)
...
#+BEGIN_SRC clojure :noweb-ref impl
  ...
  (edges
   [{points :points}]
   (g/edges* identity (conj points (first points))))
  (vertex-neighbors
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/quad.cljx
  g/PInset
  (inset
   [_ inset] (th.ng.geom.types.Polygon2. (inset-polygon (:points _) inset)))
#+END_SRC
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/polygon.cljx :noweb yes :mkdip yes :padline no
  (ns thi.ng.geom.polygon
    (:require
     [thi.ng.geom.core :as g]
     [thi.ng.geom.core.utils :as gu]
     [thi.ng.geom.core.vectors :refer [vec2 vec3]]
