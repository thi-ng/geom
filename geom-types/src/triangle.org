...
#+BEGIN_SRC clojure :noweb-ref helpers
  ...
  (defn norm-sign3
    ([a b c] (g/dot (g/cross (g/- b a) (g/- c a)) V3Z))
    ([a b c n] (g/dot (g/cross (g/- b a) (g/- c a)) n)))

  (defn clockwise3?
    ([a b c] (neg? (norm-sign3 a b c V3Z)))
...
#+BEGIN_SRC clojure :noweb-ref impl2
  g/PBoundary
  (contains-point?
   [_ p] (gu/point-in-triangle2? p (:points _)))
#+END_SRC
**** PBounds                                                    :usetemplate:
#+BEGIN_SRC clojure :noweb-ref impl2 :noweb yes
...
#+BEGIN_SRC clojure :noweb-ref impl3
  g/PBoundary
  (contains-point? [_ p] (gu/point-in-triangle3? p (:points _)))
#+END_SRC
**** PBounds                                                    :usetemplate:
#+BEGIN_SRC clojure :noweb-ref impl3 :noweb yes
...
#+BEGIN_SRC clojure :noweb-ref impl3
  g/PIntersect
  (intersect-ray
   [{[a b c] :points} {p :p dir :dir}]
    (gu/intersect-ray-triangle3? p dir a b c))
#+END_SRC
