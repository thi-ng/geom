...
#+BEGIN_SRC clojure :noweb-ref impl
  ...
  (bounds
   [{p :p r :r}]
   (let [d (* 2 r)] (thi.ng.geom.types.Rect2. (m/- p r) (vec2 d))))
  (width  [_] (* 2.0 (:r _)))
  (height [_] (* 2.0 (:r _)))
  (depth  [_] 0)
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref impl
  ...
  (point-at
   [_ t]
   (m/+ (:p _) (g/as-cartesian (vec2 (:r _) (* t TWO_PI)))))
  (random-point
   [_] (g/point-at _ (m/random)))
  (random-point-inside
   [_]
   (m/+ (:p _) (v/randvec2 (m/random (:r _)))))
  (sample-uniform
...
#+BEGIN_SRC clojure :noweb-ref impl
  ...
  g/IScale
  (scale [_ s] (thi.ng.geom.types.Circle2. (m/* (:p _) s) (* (:r _) s)))
  (scale-size [_ s] (thi.ng.geom.types.Circle2. (:p _) (* (:r _) s)))
  g/ITranslate
  (translate [_ t] (thi.ng.geom.types.Circle2. (m/+ (:p _) t) (:r _)))
  g/ITransform
