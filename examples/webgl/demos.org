...
#+BEGIN_SRC js
  thi.ng.geom.examples.webgl.ex01.demo()
#+END_SRC
...
This demo utilizes the [[../../src/webgl/shaders.org#basic][basic color shader]] to draw two filled, rotating
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex01.cljs :noweb yes :mkdirp yes :padline no
   (ns thi.ng.geom.examples.webgl.ex01
     <<require-macros>>
     (:require
      <<default-requires>>
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex02.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.examples.webgl.ex02
    <<require-macros>>
    (:require
     <<default-requires>>
     [thi.ng.geom.webgl.shaders.basic :as basic]))
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex02a.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.examples.webgl.ex02a
    <<require-macros>>
    (:require
     <<default-requires>>
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex03.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.examples.webgl.ex03
    <<require-macros>>
    (:require
     <<default-requires>>
       ...
       (fn [t frame]
         (let [rot (g/rotate-y M44 (* t 0.5))
           ...
           (doto gl
             ...
             (phong/draw (assoc-in model [:uniforms :model] tx1))
             (phong/draw
              (-> model
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex04.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.examples.webgl.ex04
    <<require-macros>>
    (:require
     <<default-requires>>
       ...
       (fn [t frame]
         (let [cam  (cam/set-view cam {:eye #(g/rotate-y % (Math/sin t))})
           ...
           (doto gl
             ...
             (phong/draw (cam/apply planes cam))
             (phong/draw (-> box
                             (cam/apply cam)
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex05.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.examples.webgl.ex05
    <<require-macros>>
    (:require
     <<default-requires>>))
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex05a.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.examples.webgl.ex05a
    <<require-macros>>
    (:require
     <<default-requires>>
     [thi.ng.geom.circle :as c]
...
#+BEGIN_SRC clojure :tangle ../../babel/examples/webgl/ex06.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.examples.webgl.ex06
    <<require-macros>>
    (:require
     <<default-requires>>
...
#+BEGIN_SRC clojure
 ;;:tangle ../../babel/test/thi/ng/geom/webgl/example07.cljs :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.webgl.example07
    <<require-macros>>
    (:require
     <<default-requires>>
