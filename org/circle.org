...
#+BEGIN_SRC clojure :tangle babel/src-cljx/thi/ng/geom/circle.cljx
(defn circle
  ([] (thi.ng.geom.types.Circle. (vec2 0.0) 1.0))
  ([r] (thi.ng.geom.types.Circle. (vec2 0.0) r))
...
#+BEGIN_SRC clojure :tangle babel/src-cljx/thi/ng/geom/circle.cljx
  ...
  (bounds
   [{p :p r :r}]
   (let [d (* 2 r)] (Rect. (g/sub-n p r) d d)))
  (center
   ([this] (thi.ng.geom.types.Circle. (vec2 0.0) (:r this)))
    ...
    (let [delta (g/sub q p)
      ...
      (if (and (<= d (+ r1 r2)) (>= d (m/abs (- r1 r2))))
        (let [a (/ (+ (- (* r1 r1) (* r2 r2)) (* d d)) (* 2 d))
          ...
          (vec2 (g/add p perp) (g/sub p perp))))))
