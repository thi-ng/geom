...
#+BEGIN_SRC clojure :tangle babel/src-cljx/thi/ng/geom/triangle.cljx
  (defn norm-sign2
    [a b c] (g/cross (g/sub b a) (g/sub c a)))

  (defn norm-sign3
    ([a b c] (g/dot (g/cross (g/sub b a) (g/sub c a)) g/V3_Z))
    ([a b c n] (g/dot (g/cross (g/sub b a) (g/sub c a)) n)))
  ...
  (defn area3
    ([a b c] (* 0.5 (norm-sign3 a b c g/V3_Z)))
    ([a b c n] (* 0.5 (norm-sign3 a b c n))))
...
#+BEGIN_SRC clojure :tangle babel/src-cljx/thi/ng/geom/triangle.cljx
  g/PInvertible
  (invert
   [t] (thi.ng.geom.types.Triangle2. (:b t) (:a t) (:c t)))
#+END_SRC
**** PSliceable
#+BEGIN_SRC clojure :tangle babel/src-cljx/thi/ng/geom/triangle.cljx
  g/PSliceable
