...
#+BEGIN_SRC clojure :noweb-ref ctors
  ...
  (defn make-shader
    ...
    (let [vs (compile-shader gl vs gl/vertex-shader)
          fs (compile-shader gl fs gl/fragment-shader)
  ...
  (defn make-shader-from-dom
    ...
    (make-shader gl (glu/get-script-text vs-id) (glu/get-script-text fs-id)
                 uniforms attribs))
#+END_SRC
