...
* Contents                                                         :toc_4_gh:
 - [[#webgl-examples--test-scenes][WebGL examples & test scenes]]
     ...
     - [[#todo-example-5-morphogen--shadow-mapping][TODO Example 5: Morphogen & shadow mapping]]
...
** TODO Example 5: Morphogen & shadow mapping

#+BEGIN_SRC clojure
 ;;:tangle ../babel/test/thi/ng/geom/webgl/example05.cljs :noweb yes :mkdirp yes :padline no
