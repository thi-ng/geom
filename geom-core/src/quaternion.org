...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/core/quaternion.cljx :mkdirp yes :padline no
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/core/quaternion.cljx
...
#+BEGIN_SRC clojure :noweb-ref tpl-pop
  (thi.ng.geom.core.vector.Vec3. x y z)
#+END_SRC
*** compare
...
#+END_SRC
*** Clojure protocols
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/core/quaternion.cljx :noweb yes
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/core/quaternion.cljx
  ...
  (defn quat-from-axis-angle
    [axis theta]
    (let [theta (/ theta 2.0)]
      (quat (api/normalize (v/vec3 axis) (Math/sin theta)) (Math/cos theta))))
  ...
  (defn quat-from-euler
    ...
    (let [[a b c] (case order
      ...
      (api/* (quat-from-axis-angle a alpha)
  ...
  (defn alignment-quat
    ...
    (let [d (api/dot a b)]
      (cond
       (< d -0.999999) (let [c (api/cross V3X a)
                             c (if (< (api/mag c) 1e-6) (api/cross V3Y a) c)]
                         (quat-from-axis-angle c PI))
       (> d 0.999999) (quat)
       :default (api/normalize (quat (api/cross a b) (inc d))))))
#+END_SRC
  ...
  (defn swizzle4-assoc
    ...
    (if (number? k)
      ...
      (case k
        ...
        (v/swizzle-assoc* _ quat4 {\x 0 \y 1 \z 2 \w 3} k v))))
#+END_SRC
