...
#+END_SRC
*** pop
#+BEGIN_SRC clojure :noweb-ref tpl-pop
  (thi.ng.geom.core.vector.Vec3. x y z -1 #+clj -1)
#+END_SRC
*** compare
...
#+END_SRC
*** conj
#+BEGIN_SRC clojure :noweb-ref tpl-conj
  (thi.ng.geom.core.vectorseq.VectorSeq. 0 5 [x y z w v] nil)
#+END_SRC
  ...
  (transform-vector
   ...
   (let [ix (mm/maddsub w vx y vz z vy)
     ...
     (thi.ng.geom.core.vector.Vec3.
      ...
      (mm/maddsub iz w iw nz ix ny iy nx) -1 #+clj -1)))
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref ctors
  ...
  (defn quat-from-axis-angle
    [axis theta]
    (let [theta (/ theta 2.0)]
      (quat (g/* (v/vec3 axis) (Math/sin theta)) (Math/cos theta))))
