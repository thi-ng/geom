...
#+BEGIN_SRC clojure :noweb-ref vec2 :noweb yes
  ...
  ,#+clj (rseq [_] (seq ((swizzle2-fns :yx) _)))
  ,#+clj (get [_ n] (aget buf n))
  ,#+clj (nth [_ n] (aget buf n))
  ,#+clj (nth [_ n nf] (if (>= n 0) (if (< n 2) (aget buf n) nf)))
  ,#+clj (equiv
         [_ o]
...
#+BEGIN_SRC clojure :noweb-ref vec2 :noweb yes
  ...
  ,#+cljs IIndexed
  ,#+cljs (-nth [_ n] (if (>= n 0) (if (< n 2) (aget buf n) (err/key-error! n))))
  ,#+cljs (-nth [_ n nf] (if (>= n 0) (if (< n 2) (aget buf n) nf)))
...
#+BEGIN_SRC clojure :noweb-ref vec3 :noweb yes
  ...
  ,#+clj (pop
         ...
         (let [^doubles b (double-array 2)]
           ...
           (aset b 1 (aget buf 1))
           (Vec2. b nil _meta)))
  ,#+clj (rseq [_] (seq ((swizzle3-fns :zyx) _)))
  ,#+clj (get [_ n] (aget buf n))
  ,#+clj (nth [_ n] (aget buf n))
  ,#+clj (nth [_ n nf] (if (>= n 0) (if (< n 3) (aget buf n) nf)))
  ,#+clj (equiv
         [_ o]
...
#+BEGIN_SRC clojure :noweb-ref vec3 :noweb yes
  ...
  ,#+cljs IIndexed
  ,#+cljs (-nth [_ n] (if (>= n 0) (if (< n 3) (aget buf n) (err/key-error! n))))
  ,#+cljs (-nth [_ n nf] (if (>= n 0) (if (< n 3) (aget buf n) nf)))
...
#+BEGIN_SRC clojure :noweb-ref ctors
  ...
  (def V3 (Vec2. #+clj (double-array 3) #+cljs (js/Float32Array. 3) nil nil))
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/core/vector.cljx :noweb yes :mkdirp yes :padline no
  (ns thi.ng.geom.core.vector
    ...
    (:require
     ...
     ,#+clj [thi.ng.geom.core.macros.vector :as vm :refer [defswizzle]]
     ,#+clj [thi.ng.macromath.core :as mm]
     ,#+clj [clojure.core.protocols :as cp]))

  (declare V2 V3 swizzle2-fns swizzle3-fns vec3)
...
#+BEGIN_SRC clojure :tangle ../babel/src/cljx/thi/ng/geom/core/macros/vector.clj :noweb yes :mkdirp yes :padline no
