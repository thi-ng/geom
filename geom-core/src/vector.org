...
#+BEGIN_SRC clojure :noweb-ref vec2
  ...
  (mix
   [_ [ax ay]]
   (Vec2. (mm/submadd ax x 0.5 x) (mm/submadd ay y 0.5 y) -1 #+clj -1))
  (mix
   [_ [ax ay] t]
   (Vec2. (mm/submadd ax x t x) (mm/submadd ay y t y) -1 #+clj -1))
  (mix
   ...
   (let [ux (mm/submadd ax x u x)
     ...
     (Vec2.
      ...
      (mm/submadd (mm/submadd cy by u by) uy v uy) -1 #+clj -1)))
#+END_SRC
*** PHeading
#+BEGIN_SRC clojure :noweb-ref vec2
  g/PHeading
...
#+BEGIN_SRC clojure :noweb-ref vec3
  ...
  (mix
   ...
   (Vec3.
    ...
    (mm/submadd az z 0.5 z) -1 #+clj -1))
  (mix
   [_ [ax ay az] t]
   (Vec3.
    (mm/submadd ax x t x)
    (mm/submadd ay y t y)
    (mm/submadd az z t z) -1 #+clj -1))
  (mix
   ...
   (let [ux (mm/submadd ax x u x)
     ...
     (Vec3.
      ...
      (mm/submadd (mm/submadd cz bz u bz) uz v uz) -1 #+clj -1)))
#+END_SRC
*** PHeading
#+BEGIN_SRC clojure :noweb-ref vec3
  g/PHeading
