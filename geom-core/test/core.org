...
#+BEGIN_SRC clojure :noweb-ref tests
  (deftest protocol-impls
    ...
    (is (instance? thi.ng.geom.core.vectorseq.VectorSeq (conj a3 4)) "conj a3 VectorSeq?")
...
#+BEGIN_SRC clojure :noweb-ref tests
  (deftest matrix-ops
    ...
    (is (instance? thi.ng.geom.core.vectorseq.VectorSeq (conj M32 2)) "conj M32 VectorSeq?")
    (is (instance? thi.ng.geom.core.vectorseq.VectorSeq (conj M44 2)) "conj M44 VectorSeq?"))
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref tests
  (deftest quat-ops
    ...
    (is (instance? thi.ng.geom.core.vectorseq.VectorSeq (conj Q 2)) "conj Q VectorSeq?"))
#+END_SRC
