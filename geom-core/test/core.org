...
#+BEGIN_SRC clojure :tangle ../babel/test/cljx/thi/ng/geom/test/core.cljx  
  (deftest addm
   ...
   (is (= (g/* (g/+ a2 b2 b2) a2) (g/addm a2 [b2 b2] a2)) "addm a2 [b2 b2] a2")
   (is (= (g/* (g/+ a2 b2 b2) ax) (g/addm a2 [b2 b2] ax)) "addm a2 [b2 b2] ax")
   ...
   (is (= (g/* (g/+ a3 b3 b3) a3) (g/addm a3 [b3 b3] a3)) "addm a3 [b3 b3] a3")
   (is (= (g/* (g/+ a3 b3 b3) ax) (g/addm a3 [b3 b3] ax)) "addm a3 [b3 b3] ax"))
#+END_SRC
