...
#+BEGIN_SRC clojure :noweb-ref tests  
  (deftest dotproduct
   ...
   (is (== (+ (* (- ax) bx) (* (- ay) by)) (g/dot (m/- a2) b2)) "dot -a2 b2")
   ...
   (is (== (+ (* (- ax) bx) (* (- ay) by) (* (- az) bz)) (g/dot (m/- a3) b3)) "dot -a3 b3"))
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref tests  
  (deftest mag
    ...
    (is (== (Math/sqrt (+ (* ax ax) (* ay ay))) (g/mag (m/- a2))) "mag -a2")
    (is (== (+ (* ax ax) (* ay ay)) (g/mag-squared a2)) "mag-squared a2")
    (is (== (+ (* ax ax) (* ay ay)) (g/mag-squared (m/- a2))) "mag-squared -a2")
    (is (== (Math/sqrt (+ (* ax ax) (* ay ay) (* az az))) (g/mag a3)) "mag a3")
    (is (== (Math/sqrt (+ (* ax ax) (* ay ay) (* az az))) (g/mag (m/- a3))) "mag -a3")
    (is (== (+ (* ax ax) (* ay ay) (* az az)) (g/mag-squared a3)) "mag-squared a3")
    (is (== (+ (* ax ax) (* ay ay) (* az az)) (g/mag-squared (m/- a3))) "mag-squared -a3"))
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref tests  
  (deftest normalize
    (is (delta= (let [m (g/mag a2)] [(/ ax m) (/ ay m)]) (m/normalize a2)) "norm a2")
    (is (delta= (let [m (/ s (g/mag a2))] [(* m ax) (* m ay)])
            (m/normalize a2 s)) "norm a2 s")
    (is (delta= s (g/mag (m/normalize a2 s))) "mag = norm a2 s")
    ...
    (is (delta= s (g/mag (m/normalize a3 s))) "mag = norm a3 s"))
#+END_SRC
...
#+BEGIN_SRC clojure :noweb-ref tests
  (deftest matrix-ops
    (let [m32a (matrix32 (range 1 7))  m32b (matrix32 (range 10 70 10))
      ...
      (is (delta= (m/* a2 b2) (-> M32 (g/scale bx by) (g/transform-vector a2))) " a2 scale bx by")
      ...
      (is (delta= (m/* a3 b3) (-> M44 (g/scale bx by bz) (g/transform-vector a3))) " a3 scale bx by bz")
      ...
      (is (delta= (m/+ a2 b2) (-> M32 (g/translate bx by) (g/transform-vector a2))) " a2 trans bx by")
      ...
      (is (delta= (m/+ a3 b3) (-> M44 (g/translate bx by bz) (g/transform-vector a3))) " a3 trans bx by bz")
      ...
      (is (delta= 200 (m/determinant (g/scale M32 10 20))) "det M32 scaled")
      ...
      (is (delta= 6000 (m/determinant (g/scale M44 10 20 30))) "det M44 scaled")
...
#+BEGIN_SRC clojure :tangle ../babel/test/thi/ng/geom/core/test/core.cljc :noweb yes :mkdirp yes :padline no
